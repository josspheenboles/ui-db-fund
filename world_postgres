...
-- Disable triggers, constraints, and other checks temporarily
...
-- Create the table structure for `country`
CREATE TABLE country (
    code CHAR(3) NOT NULL DEFAULT '',
    name CHAR(52) NOT NULL DEFAULT '',
    continent TEXT NOT NULL DEFAULT 'Asia', -- Using TEXT with a CHECK constraint for continent
    ...
    PRIMARY KEY (code),
    CONSTRAINT valid_continent CHECK (continent IN ('Asia', 'Europe', 'North America', 'Africa', 'Oceania', 'Antarctica', 'South America'))
);

-- Create the table structure for `city`
CREATE TABLE city (
    ...
    population INT NOT NULL DEFAULT 0,
    CONSTRAINT city_countrycode_fkey FOREIGN KEY (countrycode) REFERENCES  country(code)
);
-- Drop the table if it exists
DROP TABLE IF EXISTS countrylanguage;

-- Create the table structure for `countrylanguage`
CREATE TABLE countrylanguage (
    countrycode CHAR(3) NOT NULL DEFAULT '',
    language CHAR(30) NOT NULL DEFAULT '',
    isofficial BOOLEAN NOT NULL DEFAULT FALSE, -- BOOLEAN replaces enum('T','F')
    ...
    CONSTRAINT isofficial_check CHECK (isofficial IN (TRUE, FALSE)) -- Redundant for BOOLEAN, but kept for clarity
);
-- Re-enable triggers, constraints, and checks
...
INSERT INTO country (
    ...
    'CHN', 'China', 'Asia', 'Eastern Asia', 9572900.00, -1523, 1277558000, 
    71.4, 982268.00, 917719.00, 'Zhongquo', 'People''sRepublic', 'Jiang Zemin', 
    1891, 'CN'
);
...
INSERT INTO country VALUES ('IRQ','Iraq','Asia','Middle East',438317.00,1932,23115000,66.5,11500.00,NULL,'Al-ŽIraq','Republic','Saddam Hussein al-Takriti',1365,'IQ');
...
INSERT INTO country VALUES ('PRK','North Korea','Asia','Eastern Asia',120538.00,1948,24039000,70.7,5332.00,NULL,'Choson Minjujuui InŽmin Konghwaguk (Bukhan)','Socialistic Republic','Kim Jong-il',2318,'KP');
